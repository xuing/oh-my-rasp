...
public final class Java11CommandSmoke {
  private Java11CommandSmoke() {}
  ...
  public static void main(String[] args) throws Exception {
    ...
    if ("file-normal".equals(mode)) {
      File file = new File("/tmp/ohmyrasp-java11-safe.txt");
  ...
  private static void invokeJmx(String operation, Object[] arguments, String[] signatures)
    ...
    ObjectName name = new ObjectName("ohmyrasp.java11:type=SmokeBroker,name=n" + System.nanoTime());
