...
public final class Java11ProcessTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA11] process transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
