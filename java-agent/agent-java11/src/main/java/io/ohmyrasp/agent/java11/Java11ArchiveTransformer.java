...
public final class Java11ArchiveTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA11] archive transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
