...
public final class Java11JavaBeansTransformer implements ClassFileTransformer {
  ...
  private static final Method RETHROW_IF_JAVA11_RASP_BLOCK =
      Method.getMethod("void rethrowIfJava11RaspBlock(java.lang.Object)");
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println(
            "[OHMYRASP-JAVA11] JavaBeans transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
      ...
      if ("com/sun/beans/decoder/DocumentHandler".equals(className)
        ...
        return new AdviceAdapter(Opcodes.ASM9, methodVisitor, access, name, descriptor) {
          ...
          protected void onMethodEnter() {
            loadArg(0);
            invokeStatic(HOOKS, RETHROW_IF_JAVA11_RASP_BLOCK);
          }
        };
      }
