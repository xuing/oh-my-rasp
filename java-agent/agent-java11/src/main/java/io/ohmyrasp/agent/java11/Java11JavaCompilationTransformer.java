...
public final class Java11JavaCompilationTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println(
            "[OHMYRASP-JAVA11] Java compilation transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
