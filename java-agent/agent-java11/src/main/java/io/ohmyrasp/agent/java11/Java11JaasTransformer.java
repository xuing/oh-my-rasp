...
public final class Java11JaasTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA11] JAAS transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
