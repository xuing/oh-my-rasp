...
public final class Java8JavaCompilationTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println(
            "[OHMYRASP-JAVA8] Java compilation transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
