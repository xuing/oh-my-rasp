...
public final class Java8JaasTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA8] JAAS transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
