...
public final class AbstractAutowireCapableBeanFactory {
  ...
  public static void invokeJava8DmidecodeProcessorProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecArray(
        new String[] {"dmidecode", "-t", "4"});
  }

  public static void invokeJava8CpuidProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecArray(
        new String[] {"cpuid", "-1r"});
  }

  public static void invokeJava8OsReleaseProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecString(
        "cat /etc/os-release | grep ^ID");
  }

  public static void invokeJava8LdconfigProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecString("/sbin/ldconfig -p");
  }

  public static void invokeJava8UnameProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecArray(new String[] {"uname", "-o"});
  }

  public static void invokeJava8IdentityProbe() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeProcessBuilderStart(
        new ProcessBuilder("id", "hadoop"));
  }

  public static void invokeJava8TeamCityMetadataVerifier() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecArray(
        new String[] {
  ...
  public static void invokeJava8TeamCityServerJarMetadataVerifier() {
    io.ohmyrasp.agent.java8.Java8RaspHooks.beforeRuntimeExecArray(
        new String[] {
          "/opt/java/openjdk/bin/java",
          "-classpath",
