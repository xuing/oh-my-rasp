...
public final class Java8CommandSmoke {
  private Java8CommandSmoke() {}
  ...
  public static void main(String[] args) throws Exception {
    ...
    if ("file-normal".equals(mode)) {
      File file = new File("/tmp/ohmyrasp-java8-safe.txt");
    ...
    if ("classloader-normal".equals(mode)) {
      URLClassLoader loader =
          new URLClassLoader(new URL[] {new File("/tmp/ohmyrasp-java8-safe.jar").toURI().toURL()});
      loader.close();
      return;
    }
  ...
  private static void invokeJmx(String operation, Object[] arguments, String[] signatures)
    ...
    ObjectName name = new ObjectName("ohmyrasp.java8:type=SmokeBroker,name=n" + System.nanoTime());
