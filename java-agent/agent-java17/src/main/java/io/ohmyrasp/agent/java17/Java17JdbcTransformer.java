...
public final class Java17JdbcTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] JDBC transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
