...
public final class Java17ScriptEngineTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println(
            "[OHMYRASP-JAVA17] script engine transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
