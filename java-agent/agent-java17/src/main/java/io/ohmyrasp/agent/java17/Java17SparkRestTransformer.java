...
public final class Java17SparkRestTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] Spark REST transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
