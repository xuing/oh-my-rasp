...
public final class Java17ArchiveTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] archive transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
