...
public final class Java17YarnRestTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] YARN REST transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
