...
public final class Java17JwtTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] JWT transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
