...
public final class Java17FastjsonTransformer implements ClassFileTransformer {
  private static final String TARGET = "com/alibaba/fastjson/parser/ParserConfig";
  private static final String HOOKS = "io/ohmyrasp/agent/java17/Java17RaspHooks";
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println(
            "[OHMYRASP-JAVA17] Fastjson transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
