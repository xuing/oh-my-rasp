...
public final class Java17JexlTransformer implements ClassFileTransformer {
  ...
  public byte[] transform(
    ...
    try {
      ...
      if (Boolean.getBoolean("ohmyrasp.debug")) {
        System.err.println("[OHMYRASP-JAVA17] JEXL transform failed for " + className + ": " + throwable);
      }
      return null;
    }
  }
